...
namespace Zeega.Infrastructure.GameProviders {
    public class GamesImporter {
        ...
        public void Import(IUnitOfWorkScope unitOfWorkScope) {
            ImportGameDistribution(unitOfWorkScope);
        }

        public void ImportGameDistribution(IUnitOfWorkScope unitOfWorkScope) {
